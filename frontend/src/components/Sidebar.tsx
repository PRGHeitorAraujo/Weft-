...
export default function Sidebar({ screen, onNavigate, onNewInsight, user, insightCount, bookCount, onLogout }: Props) {
  ...
  return (
    <nav style={{ width: 224, flexShrink: 0, background: "var(--panel)", borderRight: "1px solid var(--line)", display: "flex", flexDirection: "column", padding: "20px 12px 16px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <div onClick={() => onNavigate("insights")} style={navStyle(screen === "insights")}>
        ...
        <div onClick={() => onNavigate("graph")} style={navStyle(screen === "graph")}>
